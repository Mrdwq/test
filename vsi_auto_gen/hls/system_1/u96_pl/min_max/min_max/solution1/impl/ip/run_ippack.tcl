...
set Vendor      "vsi.com"
set Library     "hls"
set IPName      "min_max_shmem"
set Version     "1.0"
set DisplayName "Min_max_shmem"
set Revision    "2003120418"
...
set sdx_kernel_name "min_max_shmem"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/dwq/Documents/Workspace/vsi_dfx_lab/vsi_auto_gen/hls/system_1/u96_pl/min_max/min_max/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {min_max_shmem_am_cud
min_max_shmem_cambkb
min_max_shmem_AXILiteS_s_axi
min_max_shmem_gmem_m_axi
regslice_core
min_max_shmem
}
set kernel_xo ""
...
## Variables
set Top "min_max_shmem"
set TopNoPrefix "min_max_shmem"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 io_frame W 0x0 "Data signal of io_frame" {{0 32 io_frame W 0 "Bit 31 to 0 Data signal of io_frame"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_gmem start done"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
