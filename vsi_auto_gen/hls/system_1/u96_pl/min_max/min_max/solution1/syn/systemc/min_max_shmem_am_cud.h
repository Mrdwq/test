...
// ==============================================================
#ifndef __min_max_shmem_am_cud__HH__
#define __min_max_shmem_am_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(min_max_shmem_am_cud) {
    ...
    SC_CTOR(min_max_shmem_am_cud):  simcore_am_0_U ("simcore_am_0_U") {
