...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("start_TDATA", 32, hls_in, 1, "axis", "in_data", 1),
	Port_Property("start_TVALID", 1, hls_in, 2, "axis", "in_vld", 1),
	Port_Property("start_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
	Port_Property("start_TLAST", 1, hls_in, 2, "axis", "in_data", 1),
	Port_Property("done_TDATA", 32, hls_out, 3, "axis", "out_data", 1),
	Port_Property("done_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("done_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
	Port_Property("done_TLAST", 1, hls_out, 4, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "draw_speedometer";
